...

{
    ...
    DbgPrint("FatCommonCreate: FileObject=%x,OrgObj=%x,FileName=%wZ\n", IrpSp->FileObject,Irp->Tail.Overlay.OriginalFileObject,&IrpSp->FileObject->FileName);
...
//            DbgPrint("FatCommonCreate: FinalName is %wZ\n", &FinalName);
        ...
        if ((CreateDisposition == FILE_OPEN) ||
            ...
            DbgPrint("Cannot open nonexisting file =%wZ\n",&IrpSp->FileObject->FileName);
    ...
    try {
        ...
        DbgPrint("FatCommonCreate: Flags=%X,Status=%x\n", FileObject->Flags,Iosb.Status);
