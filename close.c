...

{
	...
	if(Fcb)
	{
		DbgPrint("FatFsdClose: Obj=%x,Name=%wZ,FcbName=%wZ,OpenCount =%d,UncleanCount=%d\n",
			FileObject,&FileObject->FileName,&Fcb->FullFileName,Fcb->OpenCount,Fcb->UncleanCount);
	}
	else
	{
		DbgPrint("FatFsdClose: None FCB, Obj=%x,Name=%wZ\n",
...

{
    ...
    if (StartWorker) {
		...
		DbgPrint("FatQueueClose: insert worker\n");
...

{
    ...
    try {
        ...
        case VirtualVolumeFile:
            ...
            DbgPrint("Close VirtualVolumeFile,InternalOpenCount=%d,ResidualOpenCount=%d\n",
				Vcb->InternalOpenCount,Vcb->ResidualOpenCount);
        ...
        case UserVolumeOpen:
            ...
            DbgPrint("Close UserVolumeOpen,DirectAccessOpenCount=%d,OpenFileCount=%d\n",
				Vcb->DirectAccessOpenCount,Vcb->OpenFileCount);
        ...
        case EaFile:
            ...
            DbgPrint("Close EaFile,InternalOpenCount=%d,ResidualOpenCount=%d\n",
				Vcb->InternalOpenCount,Vcb->ResidualOpenCount);
        ...
        case DirectoryFile:
            ...
            DbgPrint("Close DirectoryFile,InternalOpenCount=%d,ResidualOpenCount=%d\n",
				Vcb->InternalOpenCount,Vcb->ResidualOpenCount);
        ...
        case UserFileOpen:
            ...
            DbgPrint("FatCommonClose: Name=%wZ,Vcb->OpenFileCount=%d,OpenCount=%d,UncleanCount=%d\n",
				&Fcb->FullFileName,Vcb->OpenFileCount,Fcb->OpenCount,Fcb->UncleanCount);
        ...
        if (((NodeType(Fcb) == FAT_NTC_FCB) &&
            ...
            while ((NodeType(ParentDcb) == FAT_NTC_DCB) &&
                ...
                DbgPrint("Uninitialize our parent Stream Cache Map\n");
