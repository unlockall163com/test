iiiiiiiiiiiiiiiiiiiiiiiiiiii/////////////////jjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjxj/
/*++
...

{
	...
	{
		KdPrint(("FatCommonWrite:: Obj=%x,OrgObj=%x,Wait=%X,Offset=%X,Length=%X,Irp->Flags=%X,AllocationSize=%X,FileSize=%X,ValidDataLength=%X,FileName=%wZ\n",
        ...
        if ( TypeOfOpen == UserFileOpen ) {
            ...
            if ( PagingIo ) {
                ...
                if (StartingVbo >= FileSize) {
                    ...
                    DbgPrint("FatCommonWrite: PagingIo started beyond EOF.\n");
                ...
                if (ByteCount > FileSize - StartingVbo) {
                    ...
                    DbgPrint("FatCommonWrite:  PagingIo extending beyond EOF.\n");
                ...
                if ( PagingIo ) {
                    ...
                    if (!FcbAcquiredExclusive) {
                        ...
                        if (!FatAcquireExclusiveFcb( IrpContext, FcbOrDcb )) {
                            ...
                            DbgPrint("FatCommonWrite: Cannot acquire FcbOrDcb = %08lx shared without waiting\n", FcbOrDcb );
...

            ...
            if ( NonCachedIo ) {
                ...
                if (!CalledByLazyWriter &&
					...
					DbgPrint("FatCommonWrite: FatZeroData1,ValidDataToCheck=%x,StartingVbo=%x\n",
							ValidDataToCheck,StartingVbo);
...

            ...
            //
                ...
                if ( FileObject->PrivateCacheMap == NULL ) {
                    ...
                    if (!FlagOn( FileObject->Flags, FO_WRITE_THROUGH ) &&
                        ...
                        if (((StartingByte.LowPart & (PAGE_SIZE-1)) == 0) &&
							...
							DbgPrint("def: FO_WRITE_THROUGH,Obj=%x,Name=%wZ\n", FileObject,&FileObject->FileName);
                ...
                if ( StartingVbo > ValidDataToCheck ) {
                    ...
                    //
					DbgPrint("FatCommonWrite: FatZeroData2,ValidDataToCheck=%x,StartingVbo=%x\n",
							ValidDataToCheck,StartingVbo);
...

        ...
        DbgPrint("FatCommonWrite Status=%x\n", Status );
    }
